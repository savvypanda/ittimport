...
if (in_array(7,$current_user->getAuthorisedViewLevels()) || in_array(6,$current_user->getAuthorisedViewLevels()) ) : //7 is for SSCs
	$isssc = true;
endif;
...
<form action="<?php echo JRoute::_('index.php?option=com_users&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="user-form" class="form-validate" enctype="multipart/form-data">
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			...
			<?php foreach($this->form->getFieldset('user_details') as $field) :?>
				...
				<li><?php echo str_replace("Login Name","GUID",$field->label); ?>
		...
		<fieldset id="user-groups" class="adminform" <?php echo $isssc ? "style='display: none'" : "";?>>
	...
	<div class="width-40 fltrt" <?php echo $isssc ? "style='display: none'" : "";?>>
		<?php
