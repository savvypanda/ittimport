...
if (in_array(7,$current_user->getAuthorisedViewLevels())) : //7 is for SSCs
	$isssc = true;
endif;	 
...
<table class="adminlist" style="table-layout: fixed;">
	...
	?>
         ...
         <!--<tr>
			...
			<tr>
				...
				<td><h3><?php echo $this->orderstatuslist[$this->orderbt->order_status]; ?></h3></td>
			</tr>
			<tr>
			...
			<tr>
				<td class="key"><strong>Order Created By:</strong></td>
				<td><?php echo JFactory::getUser($this->orderbt->created_by)->name; ?></td>
			</tr>
		...
		<table class="adminlist" cellspacing="0" cellpadding="0">
			...
			foreach ($this->orderdetails['history'] as $this->orderbt_event ) {
				...
				$commentcode = preg_replace('@(https?://([-\w\.]+[-\w])+(:\d+)?(/([\w/_\.#-]*(\?\S+)?[^\.\s])?)?)@', '<a href="$1" target="_blank">$1</a>', $this->orderbt_event->comments);
				if(preg_match('/^(?:FedEx .*|Standard Overnight) - (\d{12,22})$/',$commentcode, $matches)) {
			...
			<tr>
				<td colspan="4">
                <?php if ($isssc) :
					$status_update_text = "Add a Comment to this Order";
				else:
					$status_update_text = "Update Order Status or Add a Comment";
				endif;
				?>
				
				<a href="#" class="show_element"><span class="vmicon vmicon-16-editadd"></span><?php echo $status_update_text;?></a>
	...
	<tr>
		...
		<table class="adminlist" cellspacing="0" cellpadding="0">
			<thead>
				<tr>
					<th>Order Creation Note [<a href="index.php?option=com_vminvoice&controller=invoices&task=editOrder&cid=<?php echo $this->orderID; ?>">edit note</a>]</th>
				</tr>
			</thead>
			<tr>
				<?php //MangoTreeMedia modifications to the virtuemart display of the customer note
					$customer_note = $this->orderbt->customer_note;
					$customer_note = nl2br($customer_note);
				?>
				<td valign="top" align="left" width="50%"><?php echo $customer_note; ?></td>
			</tr>
		</table>
		</td>
	</tr>
...
<table width="100%">
	<tr>
		...
		<table class="adminlist" width="100%">
			<thead>
				<tr>
					<th  style="text-align: center;" colspan="2">Ship to: [<a href="index.php?option=com_vminvoice&controller=invoices&task=editOrder&cid=<?php echo $this->orderID; ?>&edit_vm_order=1">edit shipping address</a>]</th>
				</tr>
			</thead>
		...
		<td width="50%" valign="top">
		<table class="adminlist hide" width="100%">
			<thead>
				<tr>
		...
		<?php } ?>
			<tr id="updateOrderItemStatus">
					...
					<td colspan="5">
						...
						&nbsp;&nbsp;&nbsp;
						<a href="#" onClick="javascript:resetForm(0);"><span class="icon-nofloat vmicon vmicon-16-remove"></span><?php echo '&nbsp;'. JText::_('COM_VIRTUEMART_CANCEL'); ?></a> &nbsp;&nbsp;&nbsp;&nbsp;<span class="icon-nofloat vmicon vmicon-16-editadd"></span><a href="index.php?option=com_vminvoice&controller=invoices&task=editOrder&cid=<?php echo $this->orderID; ?>&edit_vm_order=1">Add a New Order Item</a> <em>DO NOT DO THIS IF ORDER HAS ALREADY SHIPPED!</em>
					</td>
