    ...
    <div id="filterbox">
      <table>
        <tr>
		  ...
		  -->
          <h3>Search term:</h3> <input type="text" value="<?php echo JRequest::getVar('filter_product'); ?>" name="filter_product" size="25" />
...
<button onclick="document.adminForm.filter_product.value=''; document.adminForm.search_type.options[0].selected = true;"><?php echo JText::_('COM_VIRTUEMART_RESET'); ?></button>   
		  <?php echo $this->lists['stockfilter'] ?></td>
        </tr>
      </table>
    </div>
  ...
  <div style="text-align: left;">
    <table class="adminlist" cellspacing="0" cellpadding="0">
      <thead>
        <tr>
          ...
          <th width="10%"><?php echo $this->sort('product_sku')?></th>
          <th width="5%"><?php echo $this->sort('product_in_stock','On the Shelf (supply)') ?></th>
          <th width="5%">Pending in Student Order (Demand)</th>
	...
	if (count($this->inventorylist) > 0) {
        ...
        <tr class="row<?php echo $k ; ?>"> 
          ...
          <td><?php echo $product->product_s_desc;?></td>
